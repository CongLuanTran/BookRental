...
public class ComicBookStore {
    ...
    /**
     * A simple, less randomized generator for book's id. Books with similar titles and authors will
     * probably appear closer to each other.
     * 
     * @param title
     * @param author
     * @param volume
    ...
    /**
     * Add a new book, limited to 9999 books, and add the ID to usedID (id from 0001 to 9999, 0 is
     * reserved for exiting a function). If a id collision occurs, it will generate a new ID. This
     * should be used only to read books already stored in the text file. Don't use to read user
     * input.
     *
     * @param id
     * @param title
    ...
    /**
     * Add book without id input. Essentially the same as the full addBook function, but the ID is
     * autogenerated.
     * 
     * @param title
     * @param price
